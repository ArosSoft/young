...
import WelcomeItem from '/src/components/WelcomeItem.vue' // Компонент для отображения элементов приветствия
...
<template>
    ...
    <div id="morebutton">
        ...
        <MoreButton fileName="./young/public/text/t1.txt" imageSrc="./images/Image.jpg" />
        <!-- Можно использовать другой файл -->
        <MoreButton fileName="./young/public/text/t2.txt" imageSrc="./images/Image1.jpg" />
    </div>
