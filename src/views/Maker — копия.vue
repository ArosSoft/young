            ...
            <article class="craft-article">
                ...
                <div class="video-section">
                    ...
                    <div class="video-wrapper">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/3K8bT7nY7zI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            ...
            messages: [
              {
                ...
                Отвечай подробно, с пошаговыми инструкциями и ссылками на фото и видео. Если нужны материалы или инструменты - перечисли их в начале.
                Используй формат:
